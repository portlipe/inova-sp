  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute top-[-90px] left-[50%] transform -translate-x-1/2 lg:hidden w-[740px] max-h-screen overflow-hidden transition-transform transition-opacity duration-[3000ms] ease-in-out ${
          hasAnimated
            ? "opacity-100 translate-y-0 scale-100"
            : "opacity-0 translate-y-10 scale-95"
        }`}
      >
        <Image src={Flower} alt="big_flower_mobile" className="w-full h-full z-0 object-contain" />
      </div>
      ...
      <div className="relative lg:max-w-[466px] sm:max-w-[321px] lg:ml-32">
        ...
        <p className="lg:text-[14px] lg:leading-[22.4px] sm:text-[13px] sm:leading-[20.8px] text-black font-redhat">
          ...
          tecnologia e gestão estratégica. Oferecemos uma ampla gama de serviços especializados,
          incluindo consultoria estratégica e tecnológica, programas de inovação, trilhas de
          capacitação e pesquisas aplicadas. Nosso objetivo é promover a adoção de soluções
          inovadoras e tecnológicas que transformem a gestão das organizações, promovendo eficiência,
        ...
        <p className="lg:text-[14px] leading-[22.4px] sm:text-[13px] sm:leading-[20.8px] text-black mt-3 font-redhat">
          Nossa missão é criar soluções sob medida para os desafios de hoje e antecipar as
          necessidades de amanhã. Com isso, trabalhamos para tornar a tecnologia um ativo poderoso
          que impulsiona o crescimento e a qualidade dos serviços oferecidos à sociedade.
        </p>
      </div>
    </section>
  );
