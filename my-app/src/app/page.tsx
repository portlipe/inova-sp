      ...
      <div className="bg-white p-6 lg:w-[542px] lg:h-[245px] sm: w-[348px] sm: h-[151px] lg:px-[51px] border shadow-sm">
        ...
        <div className="flex flex-row justify-center items-center lg:mb-[47px] lg:text-[17px] lg:leading-[21px]  sm: text-[11px] sm: leading-[13px]">
          <button
            ...
            className="lg:w-[219px] lg:h-[64px] sm: w-[145px] sm: h-[41px] bg-[#5C7383] text-white px-6 py-2"
          >
            Permitir cookies
          </button>
          <button
            onClick={handleDismiss}
            className="lg:w-[103px] lg:h-[64px] sm: w-[60px] sm:h-[41px] bg-white text-[#5C7383] hover:text-gray-700"
          >
            Dispensar
          </button>
        </div>
