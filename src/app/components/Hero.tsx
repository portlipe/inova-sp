  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center relative w-full h-full">
        {/* Texto Principal */}
        <h1 className="max-w-full w-full text-[70.22px] text-white font-rajdhani font-semibold leading-[71.63px] items-center justify-center text-center animate-fade-up z-10 mt-[300px]">
